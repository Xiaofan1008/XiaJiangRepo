function info = read_Intan_RHS2000_file(path,file,print)
...
if (nargin < 2)    
    ...
    % Custom line to move to the folder containing the Intan files for later
    % access
    cd(path);
    if (file == 0)
        return;
...
info.stim_parameters = stim_parameters;
return
