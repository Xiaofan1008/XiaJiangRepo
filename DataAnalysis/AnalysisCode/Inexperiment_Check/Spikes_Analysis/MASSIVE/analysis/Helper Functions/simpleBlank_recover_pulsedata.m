...
%         end
       ...
       % thisTrig = trig(t);
        for c = 1:nChn
            ...
            data(c,thisTrig+ra(1):thisTrig+shifttime) = data(c,thisTrig+ra(1):thisTrig+shifttime) - shift;
