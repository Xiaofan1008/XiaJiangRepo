...
if save_figures
    exportgraphics(gcf, fullfile(save_dir, 'Duration_Binned_BoxPlot_v2.tiff'), 'ContentType', 'vector');
end
...
% 4. Style
yline(0, '--k', 'Alpha', 0.5); 
ylabel('\Delta Duration (Seq - Sim) [ms]', 'FontSize', 22);
xlabel('Amplitude (\muA)', 'FontSize', 22);
