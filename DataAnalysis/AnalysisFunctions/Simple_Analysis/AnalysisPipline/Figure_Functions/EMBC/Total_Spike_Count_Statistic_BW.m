...
fig_name    = 'GrandAverage_Recruitment_Curve_SignedRank_v3.tiff';
%% ================= 2. AGGREGATE DATA =================
...
for k = 1:length(Unique_Amps)
    ...
    if ~isempty(txt)
        ...
        text(amp, y_top + 0.15, txt, 'FontSize', 14, 'HorizontalAlignment', 'center', 'FontWeight', 'bold');
...
ylabel('Normalized Spike Count (a.u.)', 'FontSize', 14,  'FontName', 'Times New Roman');
legend([p1, p2], 'Location','northwest', 'Box','off', 'FontSize', 14, 'FontName', 'Times New Roman');
