...
data_folders = {
    ...
    '/Volumes/MACData/Data/Data_Xia/DX011/Xia_Exp1_Sim1' 
    % Add more folders as needed...
};

% -- Selection --
channels_to_plot = [21];                % Choose ONE channel to show multiple trials for
...
% [MODIFIED 3] Create the stacked figure FIRST before entering the folder loop
% The height automatically scales based on how many folders you put in the cell array
figure('Color','w','Position',[200 200 600 150 * nFolders]);
