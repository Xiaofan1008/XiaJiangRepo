...
file_paths = {
    ...
    % ... paste your full list of processed files here ...
};
...
tiff_dpi     = 300;  % High resolution for publication
...
errorbar(v_amps, sim_m, sim_s, '--ok', 'LineWidth', 1.5, 'MarkerSize', 8, ...
    'MarkerFaceColor', 'w', 'DisplayName', 'Simultaneous', 'CapSize', 10);

% Seq: Solid, Black Marker
errorbar(v_amps, seq_m, seq_s, '-sk', 'LineWidth', 1.5, 'MarkerSize', 8, ...
    'MarkerFaceColor', 'k', 'DisplayName', 'Sequential', 'CapSize', 10);
...
if save_figures
    ...
    filename = fullfile(save_dir, 'Population_Rext_TuningCurve.tiff');
