...
if save_figures
    exportgraphics(fig1, fullfile(save_dir, 'Population_Spike_vs_Duration_SetLevel.tiff'), ...
        'Resolution', 600);
end
...
bin_edges = 0:0.5:max(ceil(AllSpike)*2)/2;
...
if save_figures
    exportgraphics(fig2, fullfile(save_dir, 'Population_Spike_vs_Duration_Binned_SetLevel.tiff'), ...
        'Resolution', 600);
end
...
fprintf('   So the statistics are more conservative and easier to interpret.\n');
fprintf('====================================================================\n');
