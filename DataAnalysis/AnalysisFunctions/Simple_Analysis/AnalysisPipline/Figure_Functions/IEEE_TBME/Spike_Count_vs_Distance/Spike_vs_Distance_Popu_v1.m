...
visual_bin_width = 100;   % Resolution of the bar chart (um)
...
for aa = 1:length(Unique_Amps)
    ...
    for i = 1:length(file_paths)
        ...
        for ss = 1:length(R.SpatialSets)
            ...
            if norm_factor <= 0, continue; end % Avoid divide by zero
