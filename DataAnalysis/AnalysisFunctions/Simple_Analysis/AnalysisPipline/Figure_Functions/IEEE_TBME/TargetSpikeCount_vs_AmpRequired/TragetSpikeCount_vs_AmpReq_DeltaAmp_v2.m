...
figure('Units', 'centimeters', 'Position', [12, 2, 9, 9], 'Color', 'w', 'PaperPositionMode', 'auto'); hold on;
...
p3 = plot(Plot_Targets, Plot_Delta_Mean, '-o', 'Color', 'k', 'LineWidth', 2, ...
    'MarkerSize', 7, 'MarkerFaceColor', 'k', 'DisplayName', 'Simultaneous - Sequential');

yline(0, '--', 'Color', [0.4 0.4 0.4], 'LineWidth', 1.3, 'HandleVisibility', 'off');

% text(0.97, 0.92, 'Sequential lower','Units', 'normalized', ...
%     'FontName', 'Arial', 'FontSize', 10,'HorizontalAlignment', 'right');
% 
% text(0.97, 0.08, 'Simultaneous lower','Units', 'normalized', ...
%     'FontName', 'Arial', 'FontSize', 10,'HorizontalAlignment', 'right');
