...
% ================= AMP=0 CASE =================
% We want to force (0 uA, 0 Value) into the Grand Average arrays.
if Unique_Amps(1) ~= 0
    Unique_Amps     = [0; Unique_Amps];         % Prepend 0 to Amps
    Grand_Sim_Mean  = [0; Grand_Sim_Mean];      % Prepend 0 to Sim Mean
    Grand_Sim_SEM   = [0; Grand_Sim_SEM];       % Prepend 0 to Sim SEM
    Grand_Seq_Mean  = [0; Grand_Seq_Mean];      % Prepend 0 to Seq Mean
    Grand_Seq_SEM   = [0; Grand_Seq_SEM];       % Prepend 0 to Seq SEM
end
% =================================================================
