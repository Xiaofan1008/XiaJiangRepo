...
single_folder = '/Volumes/MACData/Data/Data_Xia/DX015/Xia_Single7';
sim_folder    = '/Volumes/MACData/Data/Data_Xia/DX015/Xia_Seq_Sim7';
seq_folder    = '/Volumes/MACData/Data/Data_Xia/DX015/Xia_Seq_Sim7';
...
for ia = 1:nAmp
    ...
    Linear(ia) = compact_table_value(S,s_amp,"Linear", ...
...
T = table(Amplitude_uA,NResponding,NUsed,Linear,SimMatched,Sequential, ...
    SimMinusLinear,SeqMinusLinear);
end
...
filename = sprintf('%s_%s_Linearity1_v1.mat',animal,dataset);
