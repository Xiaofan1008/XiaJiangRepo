...
D = struct('role',role,'folder',folder,'FS',FS,'sp',{sp}, ...
    'spike_file',spike_file,'spike_variable',spike_variable,'trig',trig, ...
    'experiment_file',experiment_file,'simN',simN,'E_MAP',{E.E_MAP}, ...
    'emap_labels',emap_labels,'nTrials',nTrials,'trial_labels',{trial_labels}, ...
    'order_key',order_key,'pair_key',pair_key,'trial_amp_uA',trial_amp_uA, ...
    'trial_ptd_ms',trial_ptd_ms,'set_keys',set_keys,'set_index',set_index, ...
    'BadCh',{BadCh},'BadTrials',{BadTrials},'Responding',Responding);
end
...
else, label="Not distinguishable from linear";
end
end
