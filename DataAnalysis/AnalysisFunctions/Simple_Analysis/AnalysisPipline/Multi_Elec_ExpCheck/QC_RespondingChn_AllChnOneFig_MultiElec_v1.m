%% =============================================================
%  Raster + PSTH All-Channel Viewer for Mixed-Prefix Stimulation
%
%  Purpose:
%    Plot all recording channels in one figure for each condition.
%    Useful for checking overall response pattern and verifying/modifying
%    responding-channel decisions.
%
    ...
    for ai = 1:numel(Plot_Amps_selected)
        ...
        if ismember(1, ConditionTypes_selected)
            ...
            for pi = 1:numel(Prefixes_selected)
                ...
                for ii = 1:numel(ISIs_selected)
                    ...
                    trials_this = find(conditionType_trial == 1 & ...
                    ...
                    finalArtifact_ms = max(lastActivePTD_ms(trials_this));

                    figTitle = sprintf('Set %d (%s) | Prefix %d | ISI %.1f ms | Amp %.1f uA | nTrials=%d', ...
                        setID, setLabel, prefixVal, isiVal, ampVal, numel(trials_this));
                    ...
                    for idxDepth = 1:nChPlot
                        ...
                        ch  = d(ich);                  % Intan/spike channel index
        ...
        if ismember(2, ConditionTypes_selected)
            ...
            if pool_simultaneous_across_sets
                ...
                trials_this = find(conditionType_trial == 2 & ...
            ...
            % If this set/amplitude has no simultaneous trials, skip.
            if isempty(trials_this)
                continue;
            end
            ...
            figTitle = sprintf('Set %d (%s) | %s | Amp %.1f uA | nTrials=%d', ...
                setID, setLabel, simLabel, ampVal, numel(trials_this));
