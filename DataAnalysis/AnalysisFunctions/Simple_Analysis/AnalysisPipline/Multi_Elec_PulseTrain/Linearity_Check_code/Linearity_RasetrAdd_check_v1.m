...
%
%  Important:
%    This code is a visual/checking step.
%    It does not yet perform full statistics.
% ============================================================
...
%
% Multi dataset:
% AutoSim Ch35+Ch39 Level 3:
%   5 uA  = condition 5
%   10 uA = condition 6
%
% Seq Ch35→Ch39 Level 6:
%   5 uA  = condition 17
%   10 uA = condition 18
%
% Seq Ch39→Ch35 Level 6:
%   5 uA  = condition 29
%   10 uA = condition 30
...
try
    cd(multi_data_folder);   % or single_data_folder; both should have same recording channel layout
...
function M = buildConditionMatrix(Data, condID, channels_to_analyse, d, ...
    ...
    % fprintf('Building matrix: folder = %s | condID = %d | trials = %d\n', Data.folder, condID, numel(trial_list));
