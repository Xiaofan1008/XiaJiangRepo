...
% Create a fine x-axis for smoothing
...
if length(Unique_Dists) > 3
    yy_sim = interp1(Unique_Dists, y_sim, x_fine, 'pchip'); % Shape-preserving cubic spline
...
ResultSpatial.QC.Sim = QC_Sim; ResultSpatial.QC.Seq = QC_Seq;
