...
fprintf('Condition      \t');
for ai = 1:length(Amps_sim), fprintf('%.0fuA_Mean SEM\t', Amps_sim(ai)); end; fprintf('\n');
...
out_filename = fullfile(save_dir, ['Result_Set1_SpikeNormSimMax_Zeroed_5ms_' exp_id '.mat']);
