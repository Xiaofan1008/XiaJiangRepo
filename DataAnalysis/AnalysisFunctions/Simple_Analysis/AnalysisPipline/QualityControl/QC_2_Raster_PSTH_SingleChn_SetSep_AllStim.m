...
%% ===================== USER INPUTS ===================== %%
folder_single = '/Volumes/MACData/Data/Data_Xia/DX020/Xia_ISI_Single1';
folder_seq    = '/Volumes/MACData/Data/Data_Xia/DX020/Xia_ISI_SimSeq1'; 
Electrode_Type = 2; % 0:single shank rigid; 1:single shank flex; 2:four shank flex

% --- Analysis Settings ---
target_channels = [1:5]; 
plot_amps      = [10];       % Amplitudes to plot
target_PTDs    = [0 3 5 11];  % Specific Seq PTDs to plot. Leave [] for ALL > 0.
ras_win        = [-10 50];  % ms
bin_ms         = 1;
smooth_ms      = 5;
FS             = 30000;
