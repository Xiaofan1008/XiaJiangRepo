...
Bad_Groups(c).Trials = {
      ...
      8,  [2,7,9,10,14]; % Bad
      9,  [];
      10, [1:4,6,7,8,9,11,12,13,14,20]; % Bad
      11, [3,5,6,8:11,14:16,18,21]; % Bad
      12, [3,7,8,10,12,13,15]; % Good
      13, [1,5,6,8,9,11,13]; % Bad
      14, [1,3,4,5,9,13]; % Bad
      15, [2,3,7:10,12,16]; % Bad
      17, [4:5,7,9,10,11,13,20:22,24,25,29]; % Good
      20, [2,3,8:14,16]; % Bad
};[];
...
Bad_Groups(c).Trials = {
      0,  [];
      3,  [3:5,7,9,12,13,15,18,23,28]; % Good
      4,  [];
      5,  [];
      6,  [];
      7,  [];
      ...
      9,  [];
      10, [];
      11, [1,3,6]; % Good ,11,17,20,27,28,30
      12, [2,10,11,13]; % Good ,16,17,20,21,26,28,29
      13, [3,8,9,19,22]; % Good ,23,25,29,30
      14, [1:2,10,13,15,18]; % Good ,20,23,27,28,30
      15, []; % Good
      17, [];
      20, [];
};
