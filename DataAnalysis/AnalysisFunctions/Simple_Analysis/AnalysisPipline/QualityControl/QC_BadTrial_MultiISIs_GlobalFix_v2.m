...
Bad_Groups(c).Trials = {
      ...
      3, [];
      4, [];
      5, [1:7,12,14,15,17,23]; % Good
      6, [];
      7, [];
      8, [3:5,7,10:12,14,20,22:25]; % Bad
      9, [];
      10,[4,6,7,11,14,22,24];
      11,[];
      12,[1,3:7,11,14,15,19,24];
      13,[];
      14,[];
      15,[1,3:6,11,13:18,22:24];
      17,[1,4:7,9,10,11:14,17,22:24];
      20,[1,3,5:7,9,11:17,20:25];
      25,[1:3,6:8,10:12,14:20,22:25];
};
...
Bad_Groups(c).Trials = {
      ...
      10,[18,21];
      11,[];
      12,[3,5:8,10,13,17,19,];
      13,[];
      14,[];
      15,[1,6:11,17,18,22,24,25];
      17,[1,3,5:7,9,10:13,17,21,23,25];
      20,[1,3:14,17:24]; % 16:24
      25,[1:13,15,17,19:25]; % 17:25
};
