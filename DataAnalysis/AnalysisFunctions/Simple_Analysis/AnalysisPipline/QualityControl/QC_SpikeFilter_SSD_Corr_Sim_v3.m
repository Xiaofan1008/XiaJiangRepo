...
SSD_threshold_factor  = 12;  % [MODIFIED] Stricter SSD (was 16)
corr_thresh           = 0.6; % Correlation strictness 

% 2. WINDOWS
baseline_window_ms    = [-50 -5]; % Window 1 for template (Pre-stim)
late_template_window  = [20 40];  % [NEW] Window 2 for template (Post-recovery)
