...
overrides{idx}.force_silent   = [1:32]; % Channels to turn OFF (noise)
overrides{idx}.force_respond  = [25];          % Channels to turn ON (rescue)
...
overrides{idx}.force_silent   = [1:32];        % Turn OFF
