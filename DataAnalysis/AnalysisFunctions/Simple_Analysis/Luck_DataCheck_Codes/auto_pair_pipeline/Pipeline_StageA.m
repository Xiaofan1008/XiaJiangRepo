...
%% ====================== PIPELINE SETTINGS =============================
% Settings are supplied automatically by Run_AutoPairQC.m.
config_file = getenv('AUTO_PAIR_QC_CONFIG');
if isempty(config_file) || ~isfile(config_file)
    error('AutoPairQC:MissingConfig', ...
        'Run Pipeline_StageA through Run_AutoPairQC.m.');
end
tmp_cfg = load(config_file,'PipelineConfig');
PipelineConfig = tmp_cfg.PipelineConfig;
single_folder = PipelineConfig.single_folder;
sim_folder = PipelineConfig.sim_folder;
seq_folder = PipelineConfig.seq_folder;
Electrode_Type = PipelineConfig.Electrode_Type;
FS = PipelineConfig.FS;
sim_PTD_ms = PipelineConfig.sim_PTD_ms;
seq_PTD_ms = PipelineConfig.seq_PTD_ms;
...
CFG.analysis_functions_folder = PipelineConfig.analysis_functions_folder;
...
CFG.output_folder = PipelineConfig.output_folder;
