...
filename = '/Volumes/MACData/Data/Data_Xia/DX035/Xia_100um_Single1_260924_160608/Xia_100um_Single1.mu_sab.dat';
saveFile = '/Volumes/MACData/Data/Data_Xia/DX035/Xia_100um_Single1_260924_160608/Xia_100um_Single1.sp.mat';
...
trig = loadTrig(0);
E_MAP = ProbeMAP;
map = E_MAP(2:97,7); % bilateral: A+B = 4-shank, C = single shank
...
% -------- Save once at end --------
save(saveFile, 'AllSpikes', 'fs', 'pre_ms', 'post_ms', 'stim_dur_ms', ...
