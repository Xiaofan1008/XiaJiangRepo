...
TemplateFile = 'myRasterTemplate.pptx'; %template where you can alter slide master and selection pane names layout etc.
...
replace(presentationObj,['Picture ' num],pichandle); %replace picture with name Picture 1
