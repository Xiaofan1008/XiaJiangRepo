...
ypos(ypos<10)=10+15;
xpos=x(:,i);
scatter(pvall001(:,i).*xpos-0.075, pvall001(:,i)'.*ypos,'*','k')%delete apostrophe
scatter(pvall001(:,i).*xpos+0.075, pvall001(:,i)'.*ypos,'*','k')%delete apostrophe
...
ypos=(model_series(i,:)+model_error(i,:)+0.15.*100);
ypos(ypos<10)=10+15;
scatter(pvall0001(:,i).*xpos-0.1, pvall0001(:,i)'.*ypos,'*','k')%delete apostrophe
scatter(pvall0001(:,i).*xpos+0.1, pvall0001(:,i)'.*ypos,'*','k')%delete apostrophe
...
%nsamp=[farE(4,:); betweenE(4,:); flankE(4,:)];
nsamp=resultind(4,:);
...
chosen=50;
if chosen==50
currentvariation50_r7(isnan(currentvariation50_r7))=0;
currentvariation50_r7(isinf(currentvariation50_r7))=0;
currentvariation50_r7(abs(currentvariation50_r7)>100)=0;
currentvariation50_r7(all(currentvariation50_r7 == 0,2),:)=[];
currentvariation50_r6(isnan(currentvariation50_r6))=0;
currentvariation50_r6(isinf(currentvariation50_r6))=0;
currentvariation50_r6(abs(currentvariation50_r6)>100)=0;
currentvariation50_r6(all(currentvariation50_r6 == 0,2),:)=[];
currentvariation50_r5(isnan(currentvariation50_r5))=0;
currentvariation50_r5(isinf(currentvariation50_r5))=0;
currentvariation50_r5(abs(currentvariation50_r5)>100)=0;
currentvariation50_r5(all(currentvariation50_r5 == 0,2),:)=[];
r5=currentvariation50_r5;
r6=currentvariation50_r6;
r7=currentvariation50_r7;
elseif chosen ==25
    currentvariation25_r7(isnan(currentvariation25_r7))=0;
currentvariation25_r7(isinf(currentvariation25_r7))=0;
currentvariation25_r7(abs(currentvariation25_r7)>100)=0;
currentvariation25_r7(all(currentvariation25_r7 == 0,2),:)=[];
currentvariation25_r6(isnan(currentvariation25_r6))=0;
currentvariation25_r6(isinf(currentvariation25_r6))=0;
currentvariation25_r6(abs(currentvariation25_r6)>100)=0;
currentvariation25_r6(all(currentvariation25_r6 == 0,2),:)=[];
currentvariation25_r5(isnan(currentvariation25_r5))=0;
currentvariation25_r5(isinf(currentvariation25_r5))=0;
currentvariation25_r5(abs(currentvariation25_r5)>100)=0;
currentvariation25_r5(all(currentvariation25_r5 == 0,2),:)=[];
r5=currentvariation25_r5;
r6=currentvariation25_r6;
r7=currentvariation25_r7;
elseif chosen ==75
    currentvariation75_r7(isnan(currentvariation75_r7))=0;
currentvariation75_r7(isinf(currentvariation75_r7))=0;
currentvariation75_r7(abs(currentvariation75_r7)>100)=0;
currentvariation75_r7(all(currentvariation75_r7 == 0,2),:)=[];
currentvariation75_r6(isnan(currentvariation75_r6))=0;
currentvariation75_r6(isinf(currentvariation75_r6))=0;
currentvariation75_r6(abs(currentvariation75_r6)>100)=0;
currentvariation75_r6(all(currentvariation75_r6 == 0,2),:)=[];
currentvariation75_r5(isnan(currentvariation75_r5))=0;
currentvariation75_r5(isinf(currentvariation75_r5))=0;
currentvariation75_r5(abs(currentvariation75_r5)>100)=0;
currentvariation75_r5(all(currentvariation75_r5 == 0,2),:)=[];

r5=currentvariation75_r5;
r6=currentvariation75_r6;
r7=currentvariation75_r7;
end
...
chnpairnumzeros=shallowchannel-allchnpair;
chnpairnumzeros(chnpairnumzeros==shallowchannel)=-500;
r5input=currentvariation25_r5;
r6input=currentvariation25_r6;
r7input=currentvariation25_r7;
