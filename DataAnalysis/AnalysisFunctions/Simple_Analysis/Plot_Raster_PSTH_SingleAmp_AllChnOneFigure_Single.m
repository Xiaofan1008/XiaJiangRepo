...
for set_id = 1:nSets
    ...
    for ai = 1:numel(Plot_Amps)
        ...
        figTitle = sprintf('Stim %s | %.0f µA | Separate Stimualtion', setLabel, amp_val);
        ...
        title(tl, sprintf('Stim %s | %.0f µA | Separate Stimualtion',setLabel, amp_val), 'FontSize', 12, 'FontWeight', 'bold');
